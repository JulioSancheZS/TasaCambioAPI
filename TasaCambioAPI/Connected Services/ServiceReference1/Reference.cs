...
namespace ServiceReference1
{
    ...
    public partial class Tipo_Cambio_BCNSoapClient : System.ServiceModel.ClientBase<ServiceReference1.Tipo_Cambio_BCNSoap>, ServiceReference1.Tipo_Cambio_BCNSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ServiceReference1.RecuperaTC_MesResponse> ServiceReference1.Tipo_Cambio_BCNSoap.RecuperaTC_MesAsync(ServiceReference1.RecuperaTC_MesRequest request)
        {
            return base.Channel.RecuperaTC_MesAsync(request);
        }
        
        public System.Threading.Tasks.Task<ServiceReference1.RecuperaTC_MesResponse> RecuperaTC_MesAsync(int Ano, int Mes)
        {
            ServiceReference1.RecuperaTC_MesRequest inValue = new ServiceReference1.RecuperaTC_MesRequest();
            inValue.Body = new ServiceReference1.RecuperaTC_MesRequestBody();
            inValue.Body.Ano = Ano;
            inValue.Body.Mes = Mes;
            return ((ServiceReference1.Tipo_Cambio_BCNSoap)(this)).RecuperaTC_MesAsync(inValue);
        }
